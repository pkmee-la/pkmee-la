...
const u16 gMetatiles_Snow1[] = INCBIN_U16("data/tilesets/primary/snow_1/metatiles.bin");
const u16 gMetatileAttributes_Snow1[] = INCBIN_U16("data/tilesets/primary/snow_1/metatile_attributes.bin");
